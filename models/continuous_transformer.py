...
continuous_transformer = ContinuousTransformer(num_layers, d_model, num_heads, dff,
...
def train_step(inp, tar):
    ...
    with tf.GradientTape() as tape:
        predictions, _ = continuous_transformer(inp, tar_inp,
                                                True,
                                                enc_padding_mask,
                                                combined_mask,
                                                dec_padding_mask)
...
def evaluate(inp_sentence):
    ...
    for i in range(MAX_LENGTH):
        ...
        predictions, attention_weights = continuous_transformer(encoder_input,
                                                                output,
                                                                False,
                                                                enc_padding_mask,
                                                                combined_mask,
