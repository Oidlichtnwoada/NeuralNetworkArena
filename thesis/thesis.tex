...
\begin{sidewaystable}[h]
    \centering{}
    \resizebox{\linewidth}{!}{\csvautotabular[respect all]{../benchmark_logs/statistics/#1.csv}}
    \caption{statistics of test loss and metrics for #2 Benchmark ($\mu \pm \sigma, N=3$)}
    \label{tab:test_loss_#1}
\end{sidewaystable}
\begin{figure}[h]
    \centering{}
    \includegraphics{../benchmark_logs/run_1/visualizations/#1/merged_visualizations.pdf}
    \caption{validation loss evolution during training for #2 Benchmark on second run}
...
\begin{sidewaysfigure}[h]
    ...
    \label{fig:#1_part_1}
    \caption{individual training plots for #2 Benchmark on second run - part 1}
\end{sidewaysfigure}
\begin{sidewaysfigure}[h]
    \centerline{
        \begin{minipage}[b]{0.5\linewidth}
    ...
    \label{fig:#1_part_2}
    \caption{individual training plots for #2 Benchmark on second run - part 2}
\end{sidewaysfigure}
\begin{sidewaysfigure}[h]
    \centerline{
        \begin{minipage}[b]{0.5\linewidth}
    ...
    \label{fig:#1_part_3}
    \caption{individual training plots for #2 Benchmark on second run - part 3}
\end{sidewaysfigure}
\begin{sidewaysfigure}[h]
    \centerline{
        \begin{minipage}[b]{0.5\linewidth}
    ...
    \label{fig:#1_part_4}
    \caption{individual training plots for #2 Benchmark on second run - part 4}
\end{sidewaysfigure}
\clearpage{}
}
