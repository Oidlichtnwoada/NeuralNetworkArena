...
% Switch to arabic numbering and start the enumeration of chapters in the table of content.
    ...
    Additionally, a time-continuous memory cell architecture was introduced.
    This architecture has its own benchmark test and was not benchmarked against all other fully-fledged machine learning models as it was only a proof-of-concept implementation.
    All mentioned models have been implemented in the machine learning framework Tensorflow \cite{Tensorflow}.
