...
\newcommand{\benchmarkplots}[2]{
    ...
    The individual training plots for the #2 Benchmark and each model will be shown on the following pages.
    \clearpage{}
...
\section{Add Benchmark} \label{add}
    ...
    To achieve transparency on how the results were obtained, all logs generated during the three benchmarks run by the benchmark framework described in \Cref{benchmark_framework} are available under \url{https://github.com/Oidlichtnwoada/NeuralNetworkArena/tree/master/benchmark_logs}.
