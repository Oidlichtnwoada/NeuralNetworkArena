...
\usepackage{float}
\usepackage{amsfonts,amsthm, graphicx, trfsigns, physics, xparse, mleftright, listings, xurl, csvsimple, rotating}
...
%\todo{Enter your text here.}
    ...
    \begin{sidewaystable}
        \centering{}
        \resizebox{\linewidth}{!}{\csvautotabular[respect all]{../benchmark_logs/statistics/activity.csv}}
        \caption{statistics of test loss and metrics for Activity Benchmark}
        \label{tab:test_loss_activity}
    \end{sidewaystable}
    \begin{figure}[H]
        \centering{}
        \includegraphics{../benchmark_logs/run_1/visualizations/activity/merged_visualizations.pdf}
        \caption{validation loss evolution during training for Activity Benchmark on second run}
        \label{fig:validation_loss_activity}
    \end{figure}
    ...
    \begin{sidewaystable}
        \centering{}
        \resizebox{\linewidth}{!}{\csvautotabular[respect all]{../benchmark_logs/statistics/add.csv}}
        \caption{statistics of test loss and metrics for Add Benchmark}
        \label{tab:test_loss_add}
    \end{sidewaystable}
    \begin{figure}[H]
        \centering{}
        \includegraphics{../benchmark_logs/run_1/visualizations/add/merged_visualizations.pdf}
        \caption{validation loss evolution during training for Add Benchmark on second run}
        \label{fig:validation_loss_add}
    \end{figure}
    ...
    \begin{sidewaystable}
        \centering{}
        \resizebox{\linewidth}{!}{\csvautotabular[respect all]{../benchmark_logs/statistics/walker.csv}}
        \caption{statistics of test loss and metrics for Walker Benchmark}
        \label{tab:test_loss_walker}
    \end{sidewaystable}
    \begin{figure}[H]
        \centering{}
        \includegraphics{../benchmark_logs/run_1/visualizations/walker/merged_visualizations.pdf}
        \caption{validation loss evolution during training for Walker Benchmark on second run}
        \label{fig:validation_loss_walker}
    \end{figure}
    ...
    \begin{sidewaystable}
        \centering{}
        \resizebox{\linewidth}{!}{\csvautotabular[respect all]{../benchmark_logs/statistics/memory.csv}}
        \caption{statistics of test loss and metrics for Memory Benchmark}
        \label{tab:test_loss_memory}
    \end{sidewaystable}
    \begin{figure}[H]
        \centering{}
        \includegraphics{../benchmark_logs/run_1/visualizations/memory/merged_visualizations.pdf}
        \caption{validation loss evolution during training for Memory Benchmark on second run}
        \label{fig:validation_loss_memory}
    \end{figure}
    ...
    \begin{sidewaystable}
        \centering{}
        \resizebox{\linewidth}{!}{\csvautotabular[respect all]{../benchmark_logs/statistics/mnist.csv}}
        \caption{statistics of test loss and metrics for MNIST Benchmark}
        \label{tab:test_loss_mnist}
    \end{sidewaystable}
    \begin{figure}[H]
        \centering{}
        \includegraphics{../benchmark_logs/run_1/visualizations/mnist/merged_visualizations.pdf}
        \caption{validation loss evolution during training for MNIST Benchmark on second run}
        \label{fig:validation_loss_mnist}
    \end{figure}
    ...
    \begin{sidewaystable}
        \centering{}
        \resizebox{\linewidth}{!}{\csvautotabular[respect all]{../benchmark_logs/statistics/cell.csv}}
        \caption{statistics of test loss and metrics for Cell Benchmark}
        \label{tab:test_loss_cell}
    \end{sidewaystable}
    \begin{figure}[H]
        \centering{}
        \includegraphics{../benchmark_logs/run_1/visualizations/cell/merged_visualizations.pdf}
        \caption{validation loss evolution during training for Cell Benchmark on second run}
        \label{fig:validation_loss_cell}
    \end{figure}
