...
\newcommand{\thesistitle}{NeuralNetworkArena: Comparing Machine Learning Models using Long-Term Dependency and Physical System Time Series Benchmarks} % The title of the thesis. The English version should be used, if it exists.
