...
%\todo{Enter your text here.}
    ...
    Training the LSTM model from the Keras library is optimized as it uses a fast cuDNN \cite{cuDNN} implementation.
    ...
    Training the GRU model from the Keras library is optimized as it uses a fast cuDNN \cite{cuDNN} implementation.
