...
%\todo{Enter your text here.}
    ...
    As both modifications dramatically increase model complexity and training duration compared to the standard Transformer architecture, there are not a viable option for real-world applications.
