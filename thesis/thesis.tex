...
%\todo{Enter your text here.}
    ...
    As the output vector size has the be variable, the real part of the output vector of the model was then fed to a dense layer to achive the right output vector dimension.
    ...
    This model is an original contribution and very similar in nature to the Unitary RNN \ref{urnn}.
