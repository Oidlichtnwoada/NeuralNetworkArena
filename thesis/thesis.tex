...
\usepackage{float}
\usepackage{amsfonts,amsthm, graphicx, trfsigns, physics, xparse, mleftright, listings}
...
%\end{danksagung*}
    ...
    \begin{acknowledgements*}
        ...
        I have to specifically point out that he was always willing to help me and provided his responses incredibly fast.
...
% Switch to arabic numbering and start the enumeration of chapters in the table of content.
    ...
    \begin{align} 
        ...
        y(t) &= h(x(t),u(t),t)
    \end{align}
    This form of system description is applicable to all continuous physical systems in our daily surroundings, most of them are even time-invariant. 
    ...
    \begin{figure}[H]
        ...
        \caption{visualization of the input-output relation of a continuous system}
    ...
    \begin{figure}[H]
        ...
        \caption{visualization of the input-output relation of a discrete system}
    ...
    Nevertheless, there are also some older architectures that exploit continuous-time dynamics in machine learning models like the CT-RNN architecture \cite{CTRNN}.
...
%\todo{Enter your text here.}
    ...
    This means the loss function is computed only on validation data, which is data that the model has never seen before.
    ...
    The memory high and low symbol represent the expected output symbol when either memory state is active but the memory high symbol is also used as input symbol to activate a specific memory state sparsely, all other inputs are then set to the memory low symbol.
